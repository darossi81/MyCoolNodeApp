...
function upload_random_image(images){
  ...
  var image_path = path.join(__dirname - __dirname, 'http://exceltraining.london/draw/uploads/' + random_from_array(images)),
...
fs.readdir(__dirname - __dirname + 'http://exceltraining.london/draw/uploads/', function(err, files) {
  if (err){
    console.log(err);
  }
  else{
